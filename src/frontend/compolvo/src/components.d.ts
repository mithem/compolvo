...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    EditLicenseForm: typeof import('./components/admin/EditLicenseForm.vue')['default']
    EditServiceForm: typeof import('./components/admin/EditServiceForm.vue')['default']
    EditServiceOfferingForm: typeof import('./components/admin/EditServiceOfferingForm.vue')['default']
